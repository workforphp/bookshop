...
<head>
    ...
    @section('css')
        ...
        <script type="text/javascript" src="{{url('js/layer.js')}}"></script>
        <script type="text/javascript" src="{{url('js/haidao.offcial.general.js')}}"></script>
        <script type="text/javascript" src="{{url('js/select.js')}}"></script>
        <script type="text/javascript" src="{{url('js/haidao.validate.js')}}"></script>
    @show()
</head>
        ...
        <div class="topbar-console">
            <div class="tobar-head fl">
                <a href="#" class="topbar-logo fl">
                    <span><img src="{{url('Images/logo.png')}}" width="20" height="20"/></span>
                </a>
                    ...
                    <ul class="sidebar-trans">
                        ...
                        <li>
                            <a href="identify.html">
                                <b class="sidebar-icon"><img src="{{url('Images/icon_authentication.png')}}" width="16" height="16" /></b>
                                <span class="text-normal">实名认证</span>
                            </a>
                        </li>
                        <li>
                            <a href="message.html">
                                <b class="sidebar-icon"><img src="{{url('Images/icon_news.png')}}" width="16" height="16" /></b>
                                <span class="text-normal">消息中心</span>
                            </a>
                        </li>
                        <li>
                            <a href="money.html">
                                <b class="sidebar-icon"><img src="{{url('Images/icon_gold.png')}}" width="16" height="16" /></b>
                                <span class="text-normal">金币管理</span>
                            </a>
                        </li>
                        <li>
                            <a href="order.html">
                                <b class="sidebar-icon"><img src="{{url('Images/icon_order.png')}}" width="16" height="16" /></b>
